...
"[project]/app/api/posts/random/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        ...
        const randomPosts = posts.sort(()=>Math.random() - 0.5).slice(0, 5).map((post)=>({
                uri: post.uri,
                cid: post.cid,
                author: {
                    did: post.author.did,
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__9b43ca._.js.map